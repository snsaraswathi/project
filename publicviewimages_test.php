...
<div id="password_form">
           <div class="row">
               <div class="col-md-4">
       <form method="post" action="publicviewimage1_test.php">
                       ...
                       <table class="flex-center"  id="form_spacing" id="container3">
						...
						<td class="inline-block-center-div">
							  <form method="post" action="publicdownload_test.php">
	...
	<?php
	$images =glob("publicuploads/*.*");
	foreach($images as $image) {	
	echo "<div class=\"photo\">";
	echo "<a href='publicpic_test.php?name=".basename($image)."'><img src='".$image."' width='200' height='200' /></a>";
	echo "<br>";
	echo "<br>";
	echo "<input type='checkbox' name='files[]' value='".basename($image)."'>"." "." <a href=". $image . " download >".basename($image)."</a>";
	echo "                 ";
	echo "<a href='publicdelete_test.php?name=".$image."'><img src='delete.png' border='0' width='15' height='15'/></a>";
	echo "<br>";
	echo "</div>\n";
}
