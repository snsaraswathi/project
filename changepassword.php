           ...
           <div class="row">
              <div class="col-lg-4">
				...
				<div class="form-group" id="form_spacing">
                      ...
                      <?php echo"  <input type='text' name='inputEA' id='emailid' value='".$_SESSION['emailid']."' hidden />"; ?>
                    </div>
                   <div class="form-group" id="form_spacing">
                        <label for="password" class="form_name">OLD PASSWORD *</label>
                        <input type="password" class="form-control input-lg" name="inputOPW" id="OldPassword" placeholder="Old Password" />
                    </div>
					 <div class="form-group" id="form_spacing">
                        <label for="checkpassword" class="form_name" >NEW PASSWORD *</label>
                        <input type="password" class="form-control input-lg" name="inputPW" id="Password" placeholder="New Password" onkeyup="checkPasswordMatch();"/>
                    </div>
                    <div class="form-group" id="form_spacing">
                    ...
                    <div class="form-group">
                       ...
                       <button type="submit" class="btn btn-default" id="button_heading" disabled>Change</button>
                       </div>
                     </div>
                  </form> 
              </div>
