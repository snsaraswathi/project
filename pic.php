...
echo "<tr><td><a href='delete.php?name=uploads/".$a."'><img src='delete.png' border='0' width='30' height='30'/></a></td>";
echo "<td><a href='uploads/".$a."' download><img src='download-icon.png' border='0' width='30' height='30'/></a></td>";
?>
<td>
...
echo "<img src=uploads/".$a." width='800' height='800'  />";
echo "</div></div></div>";
?>
</form>	
</body>
